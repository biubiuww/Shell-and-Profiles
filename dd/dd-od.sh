...
wget --no-check-certificate -qO InstallNET.sh 'https://raw.githubusercontent.com/biubiuww/Shell-and-Profiles/master/dd/InstallNET.sh' && chmod a+x InstallNET.sh && wget -N --no-check-certificate https://github.com/veip007/Network-Reinstall-System-Modify/raw/master/Network-Reinstall-System-Modify.sh && chmod a+x Network-Reinstall-System-Modify.sh
